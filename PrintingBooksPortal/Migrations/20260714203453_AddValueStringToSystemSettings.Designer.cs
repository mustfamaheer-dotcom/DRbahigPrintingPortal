...
namespace PrintingBooksPortal.Migrations
{
    ...
    [Migration("20260714203453_AddValueStringToSystemSettings")]
    partial class AddValueStringToSystemSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrintingBooksPortal.Models.PrintLog", b =>
                {
                    b.HasOne("PrintingBooksPortal.Models.Book", null)
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PrintingBooksPortal.Models.Shop", null)
                        .WithMany()
                        .HasForeignKey("ShopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
